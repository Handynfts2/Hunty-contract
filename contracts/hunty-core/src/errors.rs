...
impl fmt::Display for HuntError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            HuntError::CreatorBlacklisted => {
                write!(f, "Creator is blacklisted and cannot create hunts")
            }
        }
    }
}
...
impl From<HuntError> for HuntErrorCode {
    fn from(err: HuntError) -> Self {
        match err {
            ...
            HuntError::CreatorBlacklisted => HuntErrorCode::CreatorBlacklisted,
        }
    }
}
